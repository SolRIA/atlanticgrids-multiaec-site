  ...
  html: {
    index: {
      ...
      partner: {
        name: 'Parceiro Local',
        description:
          'Registe a sua empresa como parceiro local das empresas sócias da Plataforma Tecnológica Portuguesa da Construção',
        register: 'Registar',
      },
      associate: {
        name: 'Associado',
    ...
    sideMenu: {
      associates: 'Plataforma Colaborativa',
      projects: 'Projetos',
      project: 'Projeto',
    ...
    registed: {
      invite: 'Convidar',
      inviteMessage:
        'Venha conhecer a plataforma Multi AEC onde se pode registar e encontrar projetos no âmbito das multilaterais financeiras e fazer parte de uma rede alargada de empresas portuguesas com experiência neste sector. https://multiaec.ptpc.pt ',
    },
    login: {
