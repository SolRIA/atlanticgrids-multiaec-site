      ...
      <q-card-section class="q-pt-md">
        <q-scroll-area class="dialog-scroll">
          <div class="row q-col-gutter-md">
            <q-input v-model="projeto.nome" label="Nome" outlined readonly class="col-xs-12" />

            <q-input v-model="projeto.cliente" label="Agência executora" outlined class="col-xs-12 col-md-6" />
            <q-input v-model="projeto.setor" label="Setor" outlined class="col-xs-12 col-md-6" />

            <q-input v-model="projeto.estado" label="Estado" outlined class="col-xs-12 col-md-4" />

            <q-input v-model="projeto.data" label="Data" outlined readonly class="col-xs-12 col-md-4" />
            <q-input v-model="projeto.data_fecho" label="Data fecho" outlined readonly class="col-xs-12 col-md-4" />
