      ...
      <q-card-section class="q-pt-md">
        <q-scroll-area class="dialog-scroll">
          <div class="row q-col-gutter-md">
            <q-input v-model="projeto.nome" label="Nome" outlined class="col-xs-12" />
            ...
            <q-input v-model="projeto.data" label="Data" outlined class="col-xs-12 col-md-4">
            ...
            <q-input v-model="projeto.data_fecho" label="Data fecho" outlined class="col-xs-12 col-md-4">
              <template v-slot:append>
                <q-btn :icon="mdiCalendarMonth" flat dense color="positive">
                  <q-popup-proxy ref="qDateProxy" transition-show="scale" transition-hide="scale">
